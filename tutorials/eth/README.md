...
* Play with this https://docs.soliditylang.org/en/v0.8.4/solidity-by-example.html#safe-remote-purchase and update it

* Implement self destruct
* Find how to change owner?
* Include exmaples from here https://solidity-by-example.org/