...
export class RpcCore {
  ...
  _createMethodSend(section, method, def) {
    ...
    const callWithRegistry = async (outputAs, values) => {
      ...
      const {
        registry
      } = blockHash && _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry] ? await _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry](u8aToU8a(blockHash)) : {
