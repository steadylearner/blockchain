...
class RpcCore {
  ...
  _createMethodSend(section, method, def) {
    ...
    const callWithRegistry = async (outputAs, values) => {
      ...
      const {
        registry
      } = blockHash && (0, _classPrivateFieldLooseBase2.default)(this, _getBlockRegistry)[_getBlockRegistry] ? await (0, _classPrivateFieldLooseBase2.default)(this, _getBlockRegistry)[_getBlockRegistry]((0, _util.u8aToU8a)(blockHash)) : {
